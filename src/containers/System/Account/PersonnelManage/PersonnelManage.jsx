...
const mapDispatchToProps = (dispatch) => ({
  ...
  assignDepartmentUsers: payload => dispatch({ type: personnelManageAction.assignDepartmentUsers, payload }),
  assignUserDepartments: payload => dispatch({ type: personnelManageAction.assignUserDepartments, payload }),
