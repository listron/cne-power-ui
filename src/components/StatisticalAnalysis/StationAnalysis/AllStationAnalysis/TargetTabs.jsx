          ...
          <TabPane tab="发电量" key="1">
            <div className={styles.tabContainer}>
              <div className={styles.dataGraph}>
                ...
                <TargetStatisticPieGraph pieGraphId={'powerPie'} yAxisName={'发电量 (万kWh)'}/>
              </div>
          ...
          <TabPane tab="辐射总量" key="2">
            <div className={styles.tabContainer}>
              <div className={styles.dataGraph}>
                ...
                <AllStationMonthPie allStationMonthpie={'radiationPie'} yAxisName={'辐射总量 (MJ/㎡)'}/>
              </div>
            </div>
          </TabPane>
          <TabPane tab="等效利用小时数" key="3">
            <div className={styles.tabContainer}>
              <div className={styles.dataGraph}>
                ...
                <AllStationMonthPie allStationMonthpie={'userTimePie'} yAxisName={'等效利用小时数 (h)'}/>
              </div>
            </div>
          </TabPane>
          <TabPane tab="PR" key="4">
            <div className={styles.tabContainer}>
              <div className={styles.dataGraph}>
                ...
                <AllStationMonthPie allStationMonthpie={'PRPie'} yAxisName={'PR(%)'}/>
              </div>
            </div>
          </TabPane>
          <TabPane tab="损失电量" key="5">
            <div className={styles.tabContainer}>
              <div className={styles.dataGraph}>
                ...
                <AllStationMonthPie allStationMonthpie={'lostPowerPie'} yAxisName={'损失电量 (万kWh)'}/>
              </div>
            </div>
          </TabPane>
          <TabPane tab="损失电量等效时" key="6">
            <div className={styles.tabContainer}>
              <div className={styles.dataGraph}>
                ...
                <AllStationMonthPie allStationMonthpie={'lostPowertimePie'} yAxisName={'发电量 (h)'}/>
              </div>
            </div>
          </TabPane>
        </Tabs>
