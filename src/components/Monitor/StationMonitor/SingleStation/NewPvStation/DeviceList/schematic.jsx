...
class Schematic extends Component {
    ...
    render() {
        ...
        console.log('sketchmapData',sketchmapData)
        ...
        const commonList = {
            ...
            "202": {
                summaryInfo: [
                    ...
                    { 'id': 'DCPower', name: '直流总功率', unit: 'kWh', point: 0 },
            ...
            "304": {
                summaryInfo: [
                    ...
                    { 'id': 'totalPower', name: '总功率', unit: 'kWh', point: 0 },
                    { 'id': 'normalSize', name: '正常数', unit: '台', point: 2 },
                    { 'id': 'exceptionSize', name: '故障数', unit: '台', point: 0, hot: true },
                    { 'id': 'breakSize', name: '停机数', unit: '台', point: 0, hot: true },
                ]
            },
            "301": {
                high: {
            ...
            "201": {
                summaryInfo: [
                    ...
                    { 'id': 'DCPower', name: '交流总功率', unit: 'kWh', point: 0 },
            ...
            "all": {
                summaryInfo: [
                    ...
                    { 'id': 'DCPower', name: '交流功率', unit: 'kWh', point: 0 },
                    { 'id': 'normalSize', name: '正常运行数', unit: '台', point: 0 },
                    { 'id': 'exceptionSize', name: '限电运行数', unit: '台', point: 0, hot: true },
                    { 'id': 'breakSize', name: '正常停机数', unit: '台', point: 0, },
                    { 'id': 'exceptionSize', name: '故障停机数', unit: '台', point: 0, hot: true },
                    ...
                    <div className={styles.detailBox}>
                        ...
                        {invertType && // 分布式
                            <div className={styles.inverter} onClick={() => { this.changeTypeCode(activeInvertType) }}>
                                ...
                                <div className={`${styles.column}`}>
                                    <div>交流总功率 </div>
                                    <div> {+this.getEveryData('201').DCPower + +this.getEveryData('206').DCPower} <span> kWh</span></div>
                                </div>
