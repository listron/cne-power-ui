    ...
    return (
      <div className={styles.resourcesTabs}>
        <div className={styles.tabsBox}>
          <div className={activeKey === 1 ? styles.activeBtn : styles.normal} onClick={() => { this.checkType(1); }}>风向&nbsp;&&nbsp;风能玫瑰图</div>
          <div className={activeKey === 2 ? styles.activeBtn : styles.normal} onClick={() => { this.checkType(2); }}>风速&nbsp;&&nbsp;风能频率图</div>
        </div>
