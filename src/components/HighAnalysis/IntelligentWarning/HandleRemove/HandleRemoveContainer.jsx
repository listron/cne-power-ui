...
class HandleRemoveContainer extends Component {
    ...
    queryTransferFrom = (value) => {
        const { getHandleRemoveList, warningTypeStatus, warningType, rangTime, deviceTypeCode, warningLevel, stationCodes, orderField, orderCommand, deviceName, durationType, pageSize, pageNum, } = this.props;
