      ...
      if (!err) {
        ...
        if (deviceTypeCode === '304') {
          ...
          values.map = {
            ...
            assemblyTime: values.assemblyTime ? moment(values.assemblyTime).format('YYYY-MM-DD') : null,
            ongridTime: values.ongridTime ? moment(values.ongridTime).format('YYYY-MM-DD') : null,
            warrantyBegintime: values.warrantyBegintime ? moment(values.warrantyBegintime).format('YYYY-MM-DD') : null,
            warrantyEndtime: values.warrantyEndtime ? moment(values.warrantyEndtime).format('YYYY-MM-DD') : null,
            scrapTime: values.scrapTime ? moment(values.scrapTime).format('YYYY-MM-DD') : null,
