      ...
      if(response.data.code === '10000') {
        yield put({
          ...
          payload: {
            ...
            cleanPlanNum: response.data.data.cleanPlanNum||0,
            cleanProfit: response.data.data.cleanProfit||'',
            cleanCycle: response.data.data.cleanCycle||'',
            cleanTime: response.data.data.cleanTime||'',
