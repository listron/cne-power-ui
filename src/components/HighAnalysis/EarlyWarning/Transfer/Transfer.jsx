...
class Transfer extends Component {
  ...
  getTransferList = (param) => { // 请求数据
    ...
    let initParam = { stationCodes, belongMatrixs, startTime, endTime, pageNum, pageSize, sortField, sortMethod };
  ...
  render() {
    const { stations, pageSize, pageNum, totalNum, loading, transferList, matrixList } = this.props;
    const columns = [
      {
        title: '电站名称',
