      ...
      <div className={`${styles.stationMonitor} ${styles[theme]}`}>
        ...
        <div className={styles.stationContainer}>
          ...
          <div className={styles.allStationTitle}>
            <p className={`${stationType === '2' && styles.activeStation} `} onClick={() => {
              this.queryTargetData('2');
            }}>全部</p>
            <p className={`${stationType === '0' && styles.activeStation} `} onClick={() => {
              this.queryTargetData('0');
            }}>风电</p>
            <p className={`${stationType === '1' && styles.activeStation} `} onClick={() => {
              this.queryTargetData('1');
            }}>光伏</p>
          </div>
          }
          ...
          {stationTypeCount === 'none' && <div className={styles.noData}></div>}
          {
            ...
            <div className={styles.regionSelect}>
              ...
              <div className={styles.regionSelectCont}>
                <div onClick={() => {
                  this.regionChange('');
                }} className={`${styles.normal} ${regionName === '全部区域' && styles.active} `}> {'全部区域'}</div>
                {regionArr.map(e => {
                  return (<div
                    onClick={() => {
                      this.regionChange(e);
