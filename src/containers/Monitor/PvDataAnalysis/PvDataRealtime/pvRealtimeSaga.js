...
export function* watchPvDataRealtimeMonitor() {
  yield takeLatest(pvRealtimeAction.getAvailableDeviceType, getAvailableDeviceType);
  yield takeLatest(pvRealtimeAction.getPointInfo, getPointInfo);
  yield takeLatest(pvRealtimeAction.getRealtimeChart, getRealtimeChart);
  yield takeLatest(pvRealtimeAction.getRealtimeList, getRealtimeList);
  yield takeLatest(pvRealtimeAction.getSecendInterval, getSecendInterval);
  yield takeLatest(pvRealtimeAction.stopRealtimeChart, stopRealtimeChart);
  yield takeLatest(pvRealtimeAction.stopRealtimeList, stopRealtimeList);
}
