      ...
      tooltip: {
        ...
        formatter: function (params) {
          ...
          params.forEach((item, index) => {
            return paramsItem += `<div> <span style="display: inline-block;width: 5px;height: 5px;border-radius: 50%;background:${color[index]};vertical-align: 3px;margin-right: 3px;"> </span> ${'理论功率'} :${params[index].value === '0' || params[index].value || '--'}</div>`
          });
