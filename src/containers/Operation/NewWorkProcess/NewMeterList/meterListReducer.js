...
const newMeterList = (state = initState, action) => {
  switch (action.type) {
    case newMeterListAction.fetchSuccess:
      return state.merge(immutable.fromJS(action.payload));
    case newMeterListAction.changeStore:
      return state.merge(immutable.fromJS(action.payload));
    case newMeterListAction.resetStore:
      return initState;
  }
  return state;
};

export { newMeterList, newMeterListAction };
