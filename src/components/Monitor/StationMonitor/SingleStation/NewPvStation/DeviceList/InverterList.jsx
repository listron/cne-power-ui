...
class InverterList extends Component {
  ...
  render() {
    ...
    const renderList = [
      {
        'alarmNum': 0,
        'branchState': [500, 400, 900, 801, 802, 803, 500],
        'current': null,
        'dayPower': '2170.0',
        'deviceCapacity': '532.8000',
        'deviceCode': '350M201M2M1',
        'deviceId': '625803',
        'deviceName': 'S01-NBA',
        'devicePower': '123.2',
        'deviceStatus': 400,
        'equipmentHours': '4.07282282282282282282',
        'isLowEfficiency': 0,
        'parentDeviceCode': '350M304M5M1',
        'parentDeviceName': '01',
        'powerFactor': null,
        'powerFrequency': null,
        'reactivePower': null,
        'transferRate': '97.87873269921897998000',
      },
      {
        'alarmNum': 0,
        'branchState': [500, 400, 900, 801, 802, 803, 500],
