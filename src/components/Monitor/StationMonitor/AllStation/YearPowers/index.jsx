...
import { ValueFormat } from '../../../../Common/UtilComponent/index';
        ...
        <div className={styles.progressInfo}>
          <div className={styles.progressData}>
            <div className={styles.stationValue}>
              {/** <div>{value}</div> */}
              <div>
                <ValueFormat value={monitordataFormat(value, '--')} points={this.powerPoint(value)} valueunit={realTimeUnit} />
              </div>
              {/*<div className={styles.planOutput}>{total}</div> */}
              <div className={styles.planOutput}>
                <ValueFormat value={monitordataFormat(total, '--', points)} points={this.powerPoint(total)} valueunit={valueunit} />
              </div>
            </div>
